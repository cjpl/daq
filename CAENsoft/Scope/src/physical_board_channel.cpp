...
void PhysicalBoardChannel::DrawTrigger( int scope_index, wxDC &dc)
{
	...
	double offset_x= this->Sample2Sec( this->m_p_app_settings->m_max_log_X- ( this->m_p_app_settings->m_post_trigger+ this->m_trigger_thr_sample))+ this->m_p_app_settings->m_offset_sec[ scope_index];
