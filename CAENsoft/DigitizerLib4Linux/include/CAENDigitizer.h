...
*
* \file     CAENDigitizer.c
* \brief    CAEN - Digitizer Library
* \author   Alberto Lucchesi (support.computing@caen.it)
* \version  1.0
* \date     2009/03/06
*            
* \warning  This library is under development; the list of the functions 
*           is still incomplete
* \todo     Complete and order the register address map. 
            Complete the bit masks for the registers
* \todo     Add the support for the readout with interrupts
*
...
/**************************************************************************//**
* \fn  		CAEN_DGTZ_SetDPPParameter(int handle, uint32_t channel, CAEN_DGTZ_DPP_PARAMETER_t Param, uint16_t value);
...
* \return  0 = Success; negative numbers are error codes
******************************************************************************/
CAEN_DGTZ_ErrorCode CAENDGTZ_API CAEN_DGTZ_SetDPPParameter(int handle, uint32_t channel, CAEN_DGTZ_DPP_PARAMETER_t Param, uint16_t value);

/**************************************************************************//**
* \fn  		CAEN_DGTZ_GetDPPParameter(int handle, uint32_t channel, CAEN_DGTZ_DPP_PARAMETER_t Param, uint16_t *value);
...
* \return  0 = Success; negative numbers are error codes
******************************************************************************/
CAEN_DGTZ_ErrorCode CAENDGTZ_API CAEN_DGTZ_GetDPPParameter(int handle, uint32_t channel, CAEN_DGTZ_DPP_PARAMETER_t Param, uint16_t *value);
