...
#define CAEN_DGTZ_CHANNEL_GROUP_V1740_BASE_ADDRESS		0x10B0
...
typedef struct 
{
	uint32_t				ChSize[MAX_UINT8_CHANNEL_SIZE];
	uint8_t				*DataChannel[MAX_UINT8_CHANNEL_SIZE];
...
typedef struct 
{
	...
	uint32_t			*Charge[MAX_V1720DPP_CHANNEL_SIZE];
